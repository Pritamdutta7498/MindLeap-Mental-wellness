  ...
  return (
    ...
    >
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between p-8 overflow-y-hidden gap-12 h-full">
        ...
        <p className="text-lg mb-12 md:pr-8">Our team of experienced professionals is committed to helping you navigate life’s challenges with confidence and clarity. </p>
